...
<body>
	<form name="frm" method="post" action="mSub1ReplySave.jsp">
	<br>
	...
	<table align="center" border="0" cellspacing="1" bgcolor="#cccccc" width="500">
	  <input type="hidden" name="runq" value="<%=unq %>">
	  <input type="hidden" name="ruserid" value="<%=sessionid %>">
		<tr bgcolor="#ffffff">
			<th width="100">이름</th>
			<td>
				<input type="hidden" name="rname" value="<%=name %>" size="10"><%=name %> /
				<input type="hidden" name="rdate" value="<%=rdate %>"><%=rdate %>
			</td>
		</tr>
		<tr bgcolor="#ffffff">
			<th height="200">내용</th>
			<td>
				<textarea name="rcontent" placeholder="욕설 및 비방글은 삼가해주세요."
