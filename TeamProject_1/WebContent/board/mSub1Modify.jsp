...
<%
	/* 해당 unq의 데이터 값을 출력하기 위해 불러오기 */
		String unq = request.getParameter("unq");
			...
			String sql = " select name,date,title,content from member "
					   + " where unq = '"+unq+"' ";
...
<div id="content2">
	<form name="frm" method="post" action="mSub1ModifySave.jsp">
	...
	<div class="box">
								<!-- 
								        ...
								        공개/비공개 : select문으로 택1
					      						-->
	<br><br>
	<div class="contentMain" style="text-align:center;color:#0072bc;font-weight:bold;">게시글 수정하기</div>
		<table cellspacing="1" bgcolor="#cccccc" width="600" align="center">
			...
			<tr bgcolor="#ffffff">
				...
				<td>
					<input type="text" name="date" value="<%=date %>" style="width:97%;padding:5px;" readonly>
				</td>
			</tr>
			<tr bgcolor="#ffffff">
